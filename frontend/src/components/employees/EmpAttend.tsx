...
export default function EmployeeAttendance() {
  ...
  const handleCheckIn = async () => {
    try {
      setLoading(true);
      const res = await axios.post(`${API_URL}/checkin`, {}, { withCredentials: true });
  ...
  const handleStartBreak = async () => {
    try {
      setLoading(true);
      const res = await axios.post(`${API_URL}/break/start`, {}, { withCredentials: true });
  ...
  const handleEndBreak = async () => {
    try {
      setLoading(true);
      const res = await axios.post(`${API_URL}/break/end`, {}, { withCredentials: true });
